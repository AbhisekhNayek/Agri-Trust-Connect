...
const API_FEATURES = [
  {
    ...
    description: "Access live agricultural data through our secure API endpoints.",
    href: "/api/real-time-data",
  },
  {
    title: "Blockchain Integration",
    description: "Integrate blockchain-verified tracking into your applications.",
    href: "/api/blockchain-integration",
  },
];
      ...
      <section className="relative overflow-hidden px-4 py-20 sm:py-28 sm:px-6 lg:px-8 bg-[linear-gradient(45deg,#064e3b,#022c22,#064e3b)] animate-gradient-bg bg-[length:200%_200%] backdrop-blur-md border-b border-emerald-900/50">
        ...
        >
          ...
          <p className="mx-auto max-w-2xl text-lg sm:text-xl text-emerald-100 font-medium">
            Build powerful applications with AgriTrust's API for real-time data and blockchain integration.
          </p>
          <motion.div variants={buttonGlowVariants} whileHover="hover">
            <Button
              ...
              aria-label="Explore AgriTrust API"
            >
              <Link href="#api-features">
        ...
        <div className="mx-auto max-w-7xl">
          ...
          >
            <h2 className="text-3xl sm:text-4xl font-bold text-white flex items-center justify-center gap-2">
              <Code className="h-7 sm:h-8 w-7 sm:w-8 text-emerald-300" /> API Features
            </h2>
            <p className="text-emerald-100 mt-3 text-base sm:text-lg">
              Integrate AgriTrust's capabilities into your applications
            </p>
          </motion.div>
          <motion.div
          ...
          >
            {API_FEATURES.map((feature, index) => (
              ...
              >
                ...
                <p className="text-emerald-100 text-sm sm:text-base mt-3">{feature.description}</p>
                <Button
                  asChild
                  variant="link"
                  className="mt-4 text-emerald-400 hover:text-emerald-300 p-0"
                >
                  <Link href={feature.href} aria-label={`Learn about API feature: ${feature.title}`}>
      ...
      <section className="px-4 py-20 sm:px-6 lg:px-8 bg-[linear-gradient(45deg,#064e3b,#022c22,#064e3b)] animate-gradient-bg bg-[length:200%_200%] backdrop-blur-md">
        ...
        >
          <h2 className="mb-6 text-3xl sm:text-4xl font-bold text-white">
            🌱 Build with AgriTrust API
          </h2>
          <p className="mb-8 text-lg sm:text-xl text-emerald-100">
            Get started with our API to enhance your agricultural applications.
          </p>
